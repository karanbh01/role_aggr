...
JOB_LIST_SELECTOR = "[data-automation-id='jobResults']" # Common for the list container
...
JOB_LOCATION_SELECTOR = "[data-automation-id='locations']" # Example, often more complex
...
JOB_POSTED_DATE_SELECTOR = "[data-automation-id='postedOn']" # Common, but might be different
